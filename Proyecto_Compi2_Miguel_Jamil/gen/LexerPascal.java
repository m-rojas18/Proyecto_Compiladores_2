// Generated from /Users/miguel/Documents/UNITEC/4 Año/Trimestre 14/Compiladores II/Proyecto/Proyecto_Compiladores_2/Proyecto_Compi2_Miguel_Jamil/src/LexerPascal.g4 by ANTLR 4.10.1
...
public class LexerPascal extends Lexer {
	...
	public static final int
		...
		ID=26, INTEGER_VAL=27, BOOLEAN_VAL=28, OPSUM=29, OPMULT=30, OPREL=31, 
		OPBOOL=32, ASIGNACION=33, PUNTOCOMA=34, PUNTO=35, COMMA=36, COLON=37, 
		LPAR=38, RPAR=39, R_BRACKET=40, L_BRACKET=41, CARACTERES_ESP=42, CHAR_VAL=43, 
		WS=44, LEX_ERROR_SYMBOL=45, INICIO_COMMENT=46, FIN_COMMENT=47, NL=48, 
		VALOR=49;
	public static final int
		COMMENT=1;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"THEN", "UNTIL", "NIL", "DIV", "MOD", "AND", "OR", "NOT", "DIGITO", "LETRA", 
			"ID", "INTEGER_VAL", "BOOLEAN_VAL", "OPSUM", "OPMULT", "OPREL", "OPBOOL", 
			"ASIGNACION", "PUNTOCOMA", "PUNTO", "COMMA", "COLON", "LPAR", "RPAR", 
			"R_BRACKET", "L_BRACKET", "CARACTERES_ESP", "CHAR_VAL", "WS", "LEX_ERROR_SYMBOL", 
			"INICIO_COMMENT", "FIN_COMMENT", "NL", "VALOR"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'div'", "'mod'", "'and'", "'or'", "'not'", null, null, null, null, null, 
			null, null, "':='", "';'", "'.'", "','", "':'", "'('", "')'", "']'", 
			"'['", null, null, null, null, "'{'", "'}'", "'\\n'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"REPEAT", "THEN", "UNTIL", "NIL", "DIV", "MOD", "AND", "OR", "NOT", "ID", 
			"INTEGER_VAL", "BOOLEAN_VAL", "OPSUM", "OPMULT", "OPREL", "OPBOOL", "ASIGNACION", 
			"PUNTOCOMA", "PUNTO", "COMMA", "COLON", "LPAR", "RPAR", "R_BRACKET", 
			"L_BRACKET", "CARACTERES_ESP", "CHAR_VAL", "WS", "LEX_ERROR_SYMBOL", 
			"INICIO_COMMENT", "FIN_COMMENT", "NL", "VALOR"
		};
	}
